...
export default function About() {
  ...
  <>
    ...
    <div className="about-content" data-aos="fade-up" data-aos-delay="200" data-aos-duration="700" data-aos-easing="ease-in-out">
  ...
  <div className="relative w-full h-[84px] mt-[-1px] overflow-hidden">
      <div
        className="chaindivider absolute top-0 -left-100 w-8/4 h-full"
        style={{
