...
const session = {
  ...
  price: "$175",
  image:
    "/images/elements/477395712_17845184157410936_8145847497434619736_n.jpg",
};
...
export default function GroupService() {
  ...
  return (
    <>
      <section className="group-service hidden lg:block bg-black text-white py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-300 mt-3 text-base max-w-2xl mx-auto">
            A plan that fits your goals. Our Bronze Membership gives you access
            to expert-led group sessions and a vibrant community atmosphere.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between max-w-6xl mx-auto px-6 md:px-12 gap-8">
          ...
          <div className="service-content flex-1 space-y-6">
            <h2 className="text-3xl text-[#ffd700]">
              {session.title} MEMBERSHIP
            </h2>
      ...
      {/* MOBILE */}
      <section className="bg-black block lg:hidden text-white py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-[#e7b826]">Group Service</h1>
          <p className="text-gray-300 mt-3 text-base max-w-2xl mx-auto">
            A plan that fits your goals. Our Bronze Membership gives you access
        ...
        <div className="flex flex-col items-center justify-between max-w-6xl mx-auto px-6 md:px-12 gap-8">
          {/* LEFT SIDE: TEXT */}
          ...
          <div className="flex-1">
            <div className="relative w-screen h-[350px] md:h-[220px] rounded-xl overflow-hidden border-2 border-[#ffd700] shadow-lg">
              <Image
                src={session.image}
                alt={`${session.title} Membership`}
                fill
